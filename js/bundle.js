...
function menu() {
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_0__.getResource)(getUrl).then(data => createCard(data));
...
function modal(modalSelector, modalOpenSelector, modalTimerId) {
...
function post(modalTimerId) {
  ...
  function postUser(form) {
    form.addEventListener('submit', e => {
      ...
      const getUrl = 'https://foodmenunew.free.beeceptor.com';
      (0,_services_services__WEBPACK_IMPORTED_MODULE_1__.postData)(getUrl, json).then(data => {
        console.log(json);
...
/* harmony import */ var _modules_post__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/post */ "./js/modules/post.js");
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('2022-06-21');
  (0,_modules_calc__WEBPACK_IMPORTED_MODULE_3__["default"])();
  (0,_modules_menu__WEBPACK_IMPORTED_MODULE_4__["default"])();
  (0,_modules_post__WEBPACK_IMPORTED_MODULE_5__["default"])(modalTimerId);
